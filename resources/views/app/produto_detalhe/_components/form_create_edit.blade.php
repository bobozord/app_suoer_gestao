...
@endif   
    ...
    <input type="text" name="comprimeto" value="{{ $produto_detalhe->comprimeto ?? old('comprimeto') }}" placeholder="Comprimento" class="borda-preta">
    {{ $errors->has('comprimeto') ? $errors->first('comprimeto') : '' }}
    ...
    <button type="submit" class="borda-preta">Cadastrar</form>
</form>